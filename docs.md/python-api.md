...
| `provider`               | LLM provider: `"lmstudio"`, `"llamacpp"`, `"huggingface"`, `"openrouter"`, `"chatgpt"`, `"google"`, `"geap"` (alias `"vertexai"`), `"bedrock"`, `"generic"`, `"command"`, or a command string.                                                                                         |
...
| `project`                | Google Cloud project ID for the `geap` provider (Gemini Enterprise Agent Platform / Vertex AI). Also picked up from `GOOGLE_CLOUD_PROJECT`.                                                                                                                                            |
| `location`               | Google Cloud region for the `geap` provider (e.g. `us-central1`).                                                                                                                                                                                                                      |
